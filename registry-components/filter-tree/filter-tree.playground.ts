/**
 * Playground for `filter-tree`: the props its documentation page lets a reader turn,
...
export const playground: PlaygroundConfig = {
  keys: [
    ...
    { keys: "The disclosure arrow", does: "Opens a branch. Ticking a parent takes its children with it." },
  ],
  controls: [
