/**
 * Playground for `card16`: the props its documentation page lets a reader turn,
...
export const playground: PlaygroundConfig = {
  ...
  controls: [
    { prop: "title", label: "Title", kind: "text", placeholder: "Studio archive" },
    { prop: "count", label: "Count", kind: "text", placeholder: "24 photos" },
