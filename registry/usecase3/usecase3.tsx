...
export const usecase3Demo: UseCase3Props = {
  ...
  description: "Follow our proven process to achieve your goals faster and more efficiently.",
  steps: [
    {
      id: "step1",
...
export function UseCase3({ badge, heading, description, steps, className }: UseCase3Props) {
  return (
