...
export const usecase8Demo: UseCase8Props = {
  ...
  description: "Follow this proven journey to transform your business and achieve your goals.",
  items: [
    {
      id: "discovery",
...
export function UseCase8({ badge, heading, description, items, className }: UseCase8Props) {
  return (
              ...
              return (
                <div key={item.id} className="relative">
                  ...
                  <div className="grid md:grid-cols-2 gap-4 md:gap-6 items-center">
                    ...
                    >
                      <div
                        className={cn("flex items-center gap-3", isEven && "md:flex-row-reverse")}
                      >
                        {item.icon && (
                    ...
                    {/* Image */}
                    <div className={cn(isEven ? "md:pl-12 md:order-2" : "md:pr-12")}>
                      {item.image && (
