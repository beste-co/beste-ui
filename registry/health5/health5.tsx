  ...
  services: [
    {
      ...
      duration: "45-60 min",
      features: [
        { text: "ECG & stress testing" },
        { text: "Blood pressure monitoring" },
        { text: "Cholesterol management" },
      ],
      button: {
        label: "Learn more",
        href: "https://beste.co",
    ...
    },
    {
      ...
      duration: "30-45 min",
      features: [
        { text: "Headache & migraine treatment" },
        ...
        >
          {services.map((service, index) => {
            ...
            return (
              <div
                key={index}
                className="group/health5 flex flex-col rounded-2xl border bg-card p-4 md:p-6 transition-all hover:shadow-lg"
              >
                {/* Icon */}
                <div className="mb-4">
