...
export const showcase3Demo: Showcase3Props = {
  ...
  description: "Browse through our collection of successful projects and implementations",
  images: [
    {
...
export function Showcase3({ badge, heading, description, images = [], className }: Showcase3Props) {
  return (
