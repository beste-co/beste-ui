...
export const health4Demo: Health4Props = {
  ...
  buttons: [
    { label: "Begin your journey", href: "https://beste.co" },
    {
      label: "Our approach",
      href: "https://beste.co",
      variant: "outline",
      ...
      <div className="mx-auto max-w-6xl px-4 md:px-6">
        <div className="grid items-center gap-8 md:gap-12 lg:grid-cols-2 lg:gap-16">
          ...
          <div className={cn("max-w-xl", !isImageRight && "lg:order-2")}>
            ...
            {description && (
              <p className="mt-4 md:mt-6 text-lg text-muted-foreground md:text-xl">{description}</p>
            )}
            {buttons.length > 0 && (
          ...
          {image && (
            ...
            >
              ...
              {floatingCard && (
                ...
                >
                  <p className="text-sm leading-relaxed italic">{floatingCard.quote}</p>
