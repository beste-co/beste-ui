...
export const onboarding4Demo: Onboarding4Props = {
  ...
  description: "Watch a 2-minute video to learn the basics and get up to speed quickly.",
  video: {
    thumbnailSrc:
    ...
    <section className={cn("py-16 md:py-24 w-full", className)}>
      <div className="mx-auto max-w-3xl px-4 md:px-6">
        <div className="flex flex-col items-center text-center">
          ...
          {/* Heading */}
          {heading && <h1 className="mb-3 text-3xl font-bold md:text-4xl">{heading}</h1>}

          {/* Description */}
          {description && (
            <p className="mb-8 max-w-xl text-lg text-muted-foreground">{description}</p>
          )}
