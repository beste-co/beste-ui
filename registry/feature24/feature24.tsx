  ...
  items: [
    {
      ...
      description: "Filter across content, sections, and assets. Save views for repeatable audits.",
      image: {
    ...
    },
    {
      ...
      description: "Preflight checks for broken links, missing alt text, and incomplete metadata.",
      image: {
    ...
    },
    {
      ...
      description: "Track conversions and content performance without wiring up custom dashboards.",
      image: {
...
export function Feature24({ badge, heading, description, items = [], className }: Feature24Props) {
