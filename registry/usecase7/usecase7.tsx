...
export const usecase7Demo: UseCase7Props = {
  ...
  description: "Click on each solution to learn more about how we can help your business grow.",
  items: [
    {
      id: "automation",
...
export function UseCase7({ badge, heading, description, items, className }: UseCase7Props) {
