...
export function Testimonial6({ badge, quote, author, className }: Testimonial6Props) {
  return (
          ...
          {author && (
            <div className="flex flex-col items-center gap-4">
              ...
              <div className="flex flex-col items-center gap-1 md:flex-row md:gap-2">
                {author.name && <span className="text-base font-medium">{author.name}</span>}
                {author.position && (
                  <>
                    <span className="hidden text-muted-foreground md:inline-block">•</span>
