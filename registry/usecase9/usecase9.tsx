...
export const usecase9Demo: UseCase9Props = {
  ...
  description: "Discover how our platform adapts to your unique needs with flexible solutions.",
  columns: 3,
  items: [
    {
      id: "startups",
    ...
    },
    {
      ...
      title: "Agencies",
      description: "Manage multiple client projects with ease using our multi-tenant architecture.",
      size: "small",
    },
    {
      id: "ecommerce",
      ...
      title: "E-Commerce",
      description: "Build and scale online stores with integrated payments and inventory.",
      size: "medium",
      image: {
    ...
    },
    {
      ...
      title: "SaaS Products",
      description: "Create subscription-based products with built-in billing and user management.",
      size: "medium",
      image: {
    ...
    <section className={cn("py-16 md:py-24 w-full", className)}>
      <div className="mx-auto max-w-6xl px-4 md:px-6">
        ...
        <div className={cn(getColumnClasses(), "gap-4")}>
          {items.map((item) => (
            <div key={item.id} className="break-inside-avoid mb-4 group/usecase9">
              <div
                className={cn(
