...
import { Apple, Brain, Droplets, Footprints, type LucideIcon } from "lucide-react";
...
export const health2Demo: Health2Props = {
  ...
  buttons: [
    { label: "Update goals", href: "https://beste.co" },
    {
      label: "View history",
      href: "https://beste.co",
      variant: "outline",
        ...
        >
          {goals.map((goal, index) => {
            ...
            return (
              <div
                key={index}
                className="group/health2 rounded-2xl border bg-card p-6 hover:shadow-lg"
              >
                {/* Icon */}
                <div className="mb-4">
