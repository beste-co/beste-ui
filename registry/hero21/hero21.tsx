...
export const hero21Demo: Hero21Props = {
  slides: [
    ...
    },
    {
      ...
      description: "Transform your vision into reality with powerful tools designed for creators.",
      image: {
          ...
          {slides.map((_, idx) => (
            <button
              ...
              className={cn(
                ...
                idx === currentIndex ? "w-3 h-8" : "w-2 h-2 bg-white/30 hover:bg-white/50"
              )}
