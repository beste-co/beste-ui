...
const _allRegistryComponents_0: RegistryComponentMeta[] = [
  ...
  },
  {
    ...
    description: "Compact settings row where the label and the live value sit inside the track: magnetic tick snapping, a rubber band when you overdrag, Shift for precision, Alt-click to reset, wheel and typed input, an option to keep the handle on show while idle, on a native range input for full accessibility.",
    category: "Inspector",
