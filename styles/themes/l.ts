...
export const lTheme: Theme = {
  ...
  colors: {
    ...
    mutedForeground: "oklch(0.4495 0 0)",
    accent: "oklch(0 0 0)",
    ...
    ring: "oklch(0 0 0)",
    chart1: "oklch(0 0 0)",
    chart2: "oklch(0.252 0 0)",
    chart3: "oklch(0.3867 0 0)",
    chart4: "oklch(0.5103 0 0)",
    chart5: "oklch(0.6268 0 0)",
    sidebar: "oklch(1 0 0)",
    sidebarForeground: "oklch(0 0 0)",
    sidebarPrimary: "oklch(0 0 0)",
    sidebarPrimaryForeground: "oklch(1 0 0)",
    sidebarAccent: "oklch(0.9219 0 0)",
